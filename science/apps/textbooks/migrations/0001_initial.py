...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'Textbook Category',
                'verbose_name_plural': 'Textbook Categories',
            },
        ),
        migrations.CreateModel(
            name='Textbook',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='textbooks.TextbookCategory', verbose_name='Категория')),
